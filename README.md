...
```bash
npm install @stdlib/datasets-savoy-stopwords-sp
```
...
```bash
npm install -g @stdlib/datasets-savoy-stopwords-sp
```
...
[test-image]: https://github.com/stdlib-js/datasets-savoy-stopwords-sp/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/datasets-savoy-stopwords-sp/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/datasets-savoy-stopwords-sp
...
[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/datasets-savoy-stopwords-sp/main/LICENSE
